...
| R15 | Implemented (prototype) | Conflict-aware schema evolution (`schema.propose_change`, `schema.merge_status`, `schema.apply_merge`, MVCC row schema-version tags, concurrent add column/index merge planning) |
