...
- Checklist count: **84 done / 25 open** after closing the R09 comparative transport benchmark slice. Native Wasm query-operator codegen, SIMD, standalone in-edge execution, deeper performance replay injection, and geo-routing bundle windows remain open.
