...
- Checklist count: **90 done / 19 open** after closing the R15 rolling-deploy simulation slice. Native Wasm query-operator codegen, SIMD, standalone in-edge execution, deeper performance replay injection, and geo-routing bundle windows remain open.
