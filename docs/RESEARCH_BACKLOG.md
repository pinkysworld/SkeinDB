...
- Checklist count: **30 done / 79 open** after closing the R18 replay-regression CI comparison harness. Native Wasm codegen, SIMD, standalone in-edge execution, deeper performance replay injection, and geo-routing bundle windows remain open.
