...
- Checklist count: **91 done / 18 open** after closing the R15 SkeinAdmin schema-evolution slice. Native Wasm query-operator codegen, SIMD, standalone in-edge execution, deeper performance replay injection, and geo-routing bundle windows remain open.
