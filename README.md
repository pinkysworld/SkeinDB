...
- Eighteen research tracks (`R01`–`R20`) are hardened with evidence-backed tests, with the R06 checklist now closed; `R18` and `R19` remain prototype-level. See [docs/TRUE_STATUS_MATRIX.md](docs/TRUE_STATUS_MATRIX.md).
